...
Func_name = 'AMALGAM_DTLZ3.AMALGAM_DTLZ3'       # The benchmark function

# Plugin for the second argument of Func_name (number of objectives)
plugin = AMALGAMPar['m']

# Compute the true Pareto front for the DTLZ3 problem
FX_true = Compute_FX_true(AMALGAMPar, Func_name, 'DTLZ3', 500, plugin)
