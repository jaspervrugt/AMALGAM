...
# DTLZ1 example from the following paper
...
Func_name = 'AMALGAM_DTLZ1.AMALGAM_DTLZ1'       # The benchmark function
...
FX_true = Compute_FX_true(AMALGAMPar, Func_name, 'DTLZ1', 500, plugin)
